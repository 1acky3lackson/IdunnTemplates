...
public class GlobalCheckoutParamContext {
    ...
    /**
     * 商务处抽取的比例。也就是说所有参与者获得总额为 x 的订单，商务处获取 commercialRatio * x，参与者获取 (1 -
     * commercialRatio) * x。
     */
    ...
    /**
     * 假设模板的有效方块数量为 x，则第 i 次使用时，其计算后的方块树是 x * (templateDefectParam ** (i - 1))，i 从 1
     * 开始。
     */
    ...
    /**
     * 模板放置者在模板中的贡献比例。假设模板增加为 x，那么放置者或者 placerRatio * x，模板作者获得 (1 - placerRatio) *
     * x。
     */
