package cn.taixue.comstats.service;

import cn.taixue.comstats.config.CrawlerProperties;
import cn.taixue.comstats.dto.*;
import cn.taixue.comstats.model.*;
import cn.taixue.comstats.repository.*;
    ...
    private List<UserData> crawlData() {
        ...
        for (Map.Entry<String, CrawlerProperties.NeUser> entry : neProps.getUsers().entrySet()) {
            ...
            try {
                ...
                userData.setComments(commentsData.getData().getItem());
                ...
                userData.setFeedbacks(feedbacksData.getData().getItem());
