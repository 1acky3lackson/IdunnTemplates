...
import type { ComponentRegistry, ComponentLayer, Variable, PropValue, FunctionRegistry } from '~/components/ui/auto-form/types';
import { isVariableReference } from '~/components/ui/auto-form/types';
