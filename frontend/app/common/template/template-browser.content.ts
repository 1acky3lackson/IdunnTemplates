...
const templateBrowserContent = {
  ...
  content: {
    filters: {
      ...
      sortOrders: {
        newlyUpdated: t({
          [Locales.ENGLISH]: "Newest Updated",
          [Locales.CHINESE]: "最新更新优先",
          [Locales.CHINESE_TRADITIONAL]: "最新更新優先",
        }),
        oldlyUpdated: t({
          [Locales.ENGLISH]: "Oldest Updated",
          [Locales.CHINESE]: "最旧更新优先",
          [Locales.CHINESE_TRADITIONAL]: "最旧更新優先",
        }),
        newest: t({
          [Locales.ENGLISH]: "Newest First",
          [Locales.CHINESE]: "最新优先",
          [Locales.CHINESE_TRADITIONAL]: "最新優先",
        }),
        oldest: t({
          [Locales.ENGLISH]: "Oldest First",
          [Locales.CHINESE]: "最早优先",
          [Locales.CHINESE_TRADITIONAL]: "最早優先",
        }),
        newestLocked: t({
          [Locales.ENGLISH]: "Newest Locked First",
          [Locales.CHINESE]: "最近锁定优先",
          [Locales.CHINESE_TRADITIONAL]: "最近鎖定優先",
        }),
        oldestLocked: t({
          [Locales.ENGLISH]: "Oldest Locked First",
          [Locales.CHINESE]: "最早锁定优先",
          [Locales.CHINESE_TRADITIONAL]: "最早鎖定優先",
        }),
        tallest: t({
          [Locales.ENGLISH]: "Tallest First",
          [Locales.CHINESE]: "最高优先",
          [Locales.CHINESE_TRADITIONAL]: "最高優先",
        }),
        widest: t({
          [Locales.ENGLISH]: "Widest First",
          [Locales.CHINESE]: "最宽优先",
          [Locales.CHINESE_TRADITIONAL]: "最寬優先",
        }),
        longest: t({
          [Locales.ENGLISH]: "Longest First",
          [Locales.CHINESE]: "最长优先",
          [Locales.CHINESE_TRADITIONAL]: "最長優先",
        }),
        nameAZ: t({
          [Locales.ENGLISH]: "Name (A-Z)",
          [Locales.CHINESE]: "名称 (A-Z)",
          [Locales.CHINESE_TRADITIONAL]: "名稱 (A-Z)",
        }),
        nameZA: t({
          [Locales.ENGLISH]: "Name (Z-A)",
          [Locales.CHINESE]: "名称 (Z-A)",
          [Locales.CHINESE_TRADITIONAL]: "名稱 (Z-A)",
        }),
      },
      lockedOnly: t({
      ...
      minWidth: t({
        [Locales.ENGLISH]: "Min Width (Z Axis)",
        [Locales.CHINESE]: "最小宽度（Z轴）",
        [Locales.CHINESE_TRADITIONAL]: "最小寬度（Z軸）",
      }),
      maxWidth: t({
        [Locales.ENGLISH]: "Max Width (Z Axis)",
        [Locales.CHINESE]: "最大宽度（Z轴）",
        [Locales.CHINESE_TRADITIONAL]: "最大寬度（Z軸）",
      }),
      minLength: t({
        [Locales.ENGLISH]: "Min Length (x Axis)",
        [Locales.CHINESE]: "最小长度（X轴）",
        [Locales.CHINESE_TRADITIONAL]: "最小長度（X軸）",
      }),
      maxLength: t({
        [Locales.ENGLISH]: "Max Length (x Axis)",
        [Locales.CHINESE]: "最大长度（X轴）",
        [Locales.CHINESE_TRADITIONAL]: "最大長度（X軸）",
      }),
      minHeight: t({
        [Locales.ENGLISH]: "Min Height (Y Axis)",
        [Locales.CHINESE]: "最小高度（Y轴）",
        [Locales.CHINESE_TRADITIONAL]: "最小高度（Y軸）",
      }),
      maxHeight: t({
        [Locales.ENGLISH]: "Max Height (Y Axis)",
        [Locales.CHINESE]: "最大高度（Y轴）",
        [Locales.CHINESE_TRADITIONAL]: "最大高度（Y軸）",
      }),
      blocksUnit: t({
        [Locales.ENGLISH]: "blocks",
        [Locales.CHINESE]: "方块",
    ...
    searchBar: {
      filterBtn: t({
        [Locales.ENGLISH]: "Filters",
        [Locales.CHINESE]: "过滤",
        [Locales.CHINESE_TRADITIONAL]: "過濾",
      }),
      advancedTitle: t({
        [Locales.ENGLISH]: "Advanced Filters",
        [Locales.CHINESE]: "高级筛选",
        [Locales.CHINESE_TRADITIONAL]: "高級篩選",
      }),
      pathPrefixLabel: t({
        [Locales.ENGLISH]: "Path Prefix",
        [Locales.CHINESE]: "路径前缀",
        [Locales.CHINESE_TRADITIONAL]: "路徑前綴",
      }),
      pathPrefixDesc: t({
      ...
      nameMatchLabel: t({
        [Locales.ENGLISH]: "Name Matches",
        [Locales.CHINESE]: "名称匹配",
        [Locales.CHINESE_TRADITIONAL]: "名稱匹配",
      }),
      nameMatchDesc: t({
      ...
      commitMessageMatchLabel: t({
        [Locales.ENGLISH]: "Version Message Matches",
        [Locales.CHINESE]: "版本信息匹配",
        [Locales.CHINESE_TRADITIONAL]: "版本信息匹配",
      }),
      ...
      clearAdvanced: t({
        [Locales.ENGLISH]: "Clear Advanced Filters",
        [Locales.CHINESE]: "清空高级筛选",
        [Locales.CHINESE_TRADITIONAL]: "清空高級篩選",
      }),
      mainPlaceholder: t({
        [Locales.ENGLISH]: "Search paths fuzzy...",
        [Locales.CHINESE]: "模糊搜索路径...",
        [Locales.CHINESE_TRADITIONAL]: "模糊搜索路徑...",
      }),
      resultsCount: t({
        [Locales.ENGLISH]: "results",
        [Locales.CHINESE]: "个结果",
        [Locales.CHINESE_TRADITIONAL]: "個結果",
      }),
    },
  },
