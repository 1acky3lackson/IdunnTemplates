      ...
      <GenericCrudTable<Project>
        ...
        schema={{
          ...
          name: {
            ...
            render: (val: string) => (
              <Copyable value={val}>
                {val.substring(0, 16) + (val.length > 16 ? "..." : "")}
              </Copyable>
            ),
          },
          pathName: {
          ...
          kind: {
            ...
            filterable: true,
            render: (val) => (
              <span className="text-gray-600 bg-gray-100 px-2 py-1 rounded-md text-xs">
                {val}
              </span>
            ),
          },
...
function ProjectForm({ project, onSubmit, onCancel }: ProjectFormProps) {
  const form = useForm<ProjectFormValues>({
    ...
    defaultValues: {
      ...
      worldId:
        project && project?.world === null ? undefined : project?.world?.id,
      minX: project?.minX,
      minY: project?.minY,
      minZ: project?.minZ,
      maxX: project?.maxX,
