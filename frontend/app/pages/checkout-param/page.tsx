...
import { GlobalParamManager, type GlobalCheckoutParam } from "~/common/checkout-params/CheckoutParamsView";
...
export default function App() {
  ...
  const update = async (newConfig: Partial<GlobalCheckoutParam>, reason: string) => {
