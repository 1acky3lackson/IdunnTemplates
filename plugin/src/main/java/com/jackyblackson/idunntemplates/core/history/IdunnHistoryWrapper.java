...
public class IdunnHistoryWrapper implements Serializable {
    ...
    public void makeUndo() {
        ...
        if (historyType == HistoryType.INSTANCE_PLACE) {
            ...
            sendMessage(playerUUID, "history.undo.success", instanceId, EntityHelper.getTemplate(instanceSnapshot).getPath());
            ...
            sendMessage(playerUUID, "history.undo.staged_success", instanceId, EntityHelper.getTemplate(instanceSnapshot).getName(), parent != null ? parent.getName() : "Unknown");
            ...
            sendMessage(playerUUID, "history.undo.delete_success", instanceSnapshot.getId(), EntityHelper.getTemplate(instanceSnapshot).getPath());
            ...
            sendMessage(playerUUID, "history.undo.staged_delete_success",
                    ...
                    EntityHelper.getTemplate(instanceSnapshot).getName(),
    ...
    public void makeRedo() {
        ...
        if (historyType == HistoryType.INSTANCE_PLACE) {
            ...
            repo.saveInstance(instanceSnapshot);
            sendMessage(playerUUID, "history.redo.success", instanceSnapshot.getId(), EntityHelper.getTemplate(instanceSnapshot).getPath());
            ...
            sendMessage(playerUUID, "history.redo.staged_success", instanceSnapshot.getId(), EntityHelper.getTemplate(instanceSnapshot).getName(), parent != null ? parent.getName() : "Unknown");
            ...
            sendMessage(playerUUID, "history.redo.delete_success", instanceId, EntityHelper.getTemplate(instanceSnapshot).getPath());
